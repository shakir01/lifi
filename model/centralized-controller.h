...
class UserDeviceDataModel : public Object
{
  private:
      ...
      std::vector<Ptr<Node> >       m_lifiApNodesVector;
  ...
  public:
    ...
    void AddLiFiAPNode(Ptr<Node>);
    Ptr<Node> GetLiFiAPNode();
...
class CentralizedController : public Object
{
  private:
    ...
    std::unordered_map<uint32_t, Ptr<UserDeviceDataModel> > m_userDataModelMaps;
  ...
  public:
    ...
    void RegisterUsreDevice(uint32_t devid, Ptr<UserDeviceDataModel> userDeviceDataModel);
};
} 
#endif 
